                ...
                @forelse($leaveRequests as $leave)
                    ...
                    <tr class="border-t border-white/[0.18] transition-colors duration-[250ms] hover:bg-[#21457f]">
                        ...
                        <td class="p-4 text-[0.84375rem] text-center font-extralight">
                            <a href="{{ route('leave-requests.show', $leave->id) }}" class="inline-flex items-center justify-center bg-[#132B52] hover:bg-[#2e5ca3] text-white rounded-xl px-3 py-1.5 text-[0.6875rem] transition-all duration-[250ms]">
                                Review
                            </a>
                        </td>
                    </tr>
